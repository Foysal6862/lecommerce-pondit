...
<title>{{ config('app.name', 'Big Store') }}- @yield('title')</title>
    <!-- for-mobile-apps -->
    ...
    <link href="{{ asset('') }}asset/frontend/fonts.googleapis.com/css?family=Montserrat:400,700" rel='stylesheet'
        type='text/css'>
    <link href="{{ asset('') }}asset/frontend/fonts.googleapis.com/css?family=Noto+Sans:400,700" rel='stylesheet'
        type='text/css'>
    <!--- start-rate---->
    <script src="{{ asset('') }}asset/frontend/js/jstarbox.js"></script>
    <link rel="stylesheet" href="{{ asset('') }}asset/frontend/css/jstarbox.css" type="text/css" media="screen"
        charset="utf-8" />
    <script type="text/javascript">
        jQuery(function () {
